...
export default function Chatbot() {
  ...
  return (
    ...
    >
      <span className="text-6xl font-extrabold text-center text-transparent bg-clip-text py-12 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 w-full">
        Ankit's AI
      </span>
      ...
      <form className="flex mt-auto" onSubmit={handleSubmit}>
        <input
          ...
          placeholder="Explain some of Ankit's skills"
        />
        <button
